 ...
 if(isset($_GET['f_type']))
{
    ...
    $query1 = "SELECT * FROM foods WHERE f_type = 'Break Fast'";
    $search_result1 = filterTable($query1);

    $query2 = "SELECT * FROM foods WHERE f_type = 'Lunch'";
    $search_result2 = filterTable($query2);

    $query3 = "SELECT * FROM foods WHERE f_type = 'dinner'";
    $search_result3 = filterTable($query3);

    $query4 = "SELECT * FROM foods WHERE f_type = 'fastfood'";
    $search_result4 = filterTable($query4);

    $query5 = "SELECT * FROM foods WHERE f_type = 'beverage'";
    $search_result5 = filterTable($query5);

    $query6 = "SELECT * FROM foods WHERE f_type = 'cafe'";
  ...
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
    ...
    <div class="cover-chome2">
        ...
        <div style="align-self: flex-end;">
                    ...
                    <form action="searchfood.php" method="get" class="filter">
                        <select name="f_type" style="padding:10px;border-radius: 10px ;">
                        ...
                        <input type="text" name="f_name" class="inputfield">
                        <input type="submit" value="🔎" class="tfilter">
                    </form>
                </div>
        <!-- breakfast -->
        
        <div class="menu-box" id="Break Fast">
            <div>
                <span class="menu-title"  style="padding-left: 40px; text-transform: uppercase;" >BREAKFAST</span>
            </div>
            ...
            <div class="menu-grid" style="align-self: center;">
                ...
                <div class="menu-flex-col">
                    ...
                    <span class="menu-title2"><?php echo $row['location'];?></span>
        ...
        <!-- Lunch-->
         <div class="menu-box" id="lunch">
            <div>
                <span class="menu-title"  style="padding-left: 40px; text-transform: uppercase;" >LUNCH</span>
            </div>
        ...
        <!-- Dinner-->
         <div class="menu-box" id="dinner">
            <div>
                <span class="menu-title"  style="padding-left: 40px; text-transform: uppercase;" >DINNER</span>
            </div>
       ...
       <div class="menu-box" id="breakfast">
            <div>
                <span class="menu-title"  style="padding-left: 40px; text-transform: uppercase;" >FASTFOOD</span>
            </div>
        ...
        <!-- beverage-->
       <div class="menu-box" id="beverage">
            <div>
                <span class="menu-title"  style="padding-left: 40px; text-transform: uppercase;" >BEVERAGE</span>
            </div>
        ...
        <!-- cafe-->
        <div class="menu-box" id="cafe">
            <div>
                <span class="menu-title"  style="padding-left: 40px; text-transform: uppercase;" >CAFE</span>
            </div>

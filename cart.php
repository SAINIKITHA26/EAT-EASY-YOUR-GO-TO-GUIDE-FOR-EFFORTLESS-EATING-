  ...
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
    ...
    <div class="cover-chome2">
        ...
        <div class="login-title">
            <h1 class="header"> <span class="cover_span">CART</span></h1>
        </div>
        <!-- breakfast -->
        <div class="cart-box">
            <div>
                <span class="menu-title-black" >You selected foods are shown below</span>
            </div>
                        ...
                        foreach ($_SESSION["cart"] as $keys => $values) {
                            ...
                            echo "
                                <tr>
                                    ...
                                    <td>{$values["price"]}</td>
                                    <td>{$amt}</td>
                                    <td><a href='./cart.php?del={$values["food_id"]}'>Remove</a></td>
                                </tr>
                            ";
                        }
                        echo "
                                <tr>
                                    ...
                                    <input type ='hidden' name='username' value='sas'>
                                </tr>
                            ";
                    }
                    else{
                        echo "<script>alert('Please select the product');</script>";
                        header("location:menu.php?f_type");
                        
                    }
                ?>
            </table>
            <input type="submit" class="menu-btn" name="submit" value="Make Payment">

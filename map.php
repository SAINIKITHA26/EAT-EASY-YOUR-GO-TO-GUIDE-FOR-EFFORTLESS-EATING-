 ...
 if(isset($_GET['phone_number']))
{
    ...
    $query = "SELECT * FROM map WHERE phone_number = '".$phone_number."'";
...
<body>
  ...
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
    ...
    <div class="cover-chome">
            ...
            <div class="cover_div2">
                ...
                <div class="login-title">
                    <h1 class="header2">ORDER PLACE</h1>
    ...
    $start_place = $_POST['sp'];
    $end_place = $_POST['ep'];
    header("Location: https://www.google.com/maps/dir/{$start_place}/{$end_place}/");
    
 }
?>
                            <form action="" method="post">
                            <tr class="tr">
                                <th class="th">USER PHONE NUMBER</th>
                                <td class="td"><?php echo $row['phone_number'];?></td>
                            </tr>
                            <tr class="tr">
                                <th class="th">SHOP LOCATION</th>
                                <td class="td"><?php echo $row['start_place'];?></td>
                                <input type="hidden" name="sp" value='<?php echo $row['start_place'];?>'>
                            </tr>
                            <tr class="tr">
                                <th class="th">CUSTOMER LOCATION</th>
                                <td class="td"><?php echo $row['end_place'];?></td>
                                <input type="hidden" name="ep" value='<?php echo $row['end_place'];?>'>
                            </tr>
                            <tr class="tr">
                                <th class="th">ACTION</th>
                                <td class="td"><input type="submit" class="btn-sub" name="submit" value="VIEW"></td>
                            </tr>
                            </form>
                        </table>

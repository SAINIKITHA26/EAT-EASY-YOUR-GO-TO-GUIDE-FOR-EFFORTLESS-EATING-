 ...
 if(isset($_GET['search']))
{
    ...
    $res = $_GET['search'];
    $query = "SELECT * FROM foods WHERE f_name LIKE '%".$res."%'";
    ...
    <div class="acover" style="color: black;">
            ...
            <div class="cover_div">
                 <div class="login-title">
                    ...
                    <h2 style="color: white;"> Filtered Food Results</h2>
                </div>
                 <div style="align-self: flex-end;">
                    

                    <form action="filterfoods.php" method="get" class="filter">
                ...
                <div class="table-div">
                    <table>
                                ...
                                <tr>
                                    ...
                                    <td><img src="uploadImage/<?php echo $row['image'];?>" alt="food" width="100px" height="100px"></td>
                                    <td><?php echo $row['f_name'];?></td>
                                    <td><?php echo $row['f_type'];?></td>
                                    <td><?php echo $row['shop'];?></td>
                                    <td><?php echo $row['location'];?></td>
                                    <td><?php echo $row['price'];?></td>
                                    <td><a href="editfoods.php?food_id=<?php echo $row['food_id'];?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil svg3" viewBox="0 0 16 16">
  <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z"/>
</svg></a>
<a href="deletefoods.php?food_id=<?php echo $row['food_id'];?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash svg3" viewBox="0 0 16 16">

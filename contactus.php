...
if(isset($_POST['submit']))
                ...
                if (!$success) {
                    $errorMessage = error_get_last()['message'];
                     ...
                     echo "<script>if(confirm('Sending email is failed, check your internet connection')){document.location.href='contactus.php'};</script>";
                       
                    }else{
                        
                        echo "<script>if(confirm('Your feedback is sent sucessfully')){document.location.href='chome.php'};</script>";
  ...
  <path fill-rule="evenodd" d="M15.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 0 0-.708.708L14.293 7.5H5.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z"/>
    ...
    <div class="cover-chome">
            ...
            <div class="cover_div2">
                ...
                <div class="side-pic">
                   <img src="./image/contactus.png" width="550px" height="450px">
                </div>
                ...
                <div class="login-title">
                    ...
                    <form action="" method="post" class="formflex">
                         <label class="formtext2">User Name</label>
                            <input type="text" name="subject" class="inputfield" placeholder="Your name" required>
                        <label class="formtext2">Email</label>
                            <input type="email" name="email" class="inputfield" placeholder="example@mail.com" required>
                        <label class="formtext2">Message</label>
                            <textarea class="inputfield" name="message" placeholder="Write something.." style="height:120px"></textarea>

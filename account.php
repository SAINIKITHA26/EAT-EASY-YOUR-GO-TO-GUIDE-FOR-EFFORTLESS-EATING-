    ...
    <div class="cover-chome">
            ...
            <div class="cover_div2">
                ...
                <div class="login-title">
                    <h1 class="header2">USER PROFILE</h1>
                    ...
                    <?php while($row = mysqli_fetch_array($search_result)): ?> 
                        <table class="table">
                            ...
                            <tr class="tr">
                                ...
                                <td class="td"><?php echo $row['address1'];?></td>
                            </tr>
                            <tr class="tr">
                                <th class="th">ADDRESS 2</th>
                                <td class="td"><?php echo $row['address2'];?></td>
                            </tr>
                             <tr class="tr">
                                <th class="th">CITY</th>
                                <td class="td"><?php echo $row['city'];?></td>
                            </tr>
                        </table>

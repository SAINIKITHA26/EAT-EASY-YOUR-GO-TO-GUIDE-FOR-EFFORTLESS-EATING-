    ...
    <div class="cover-ahome">
            ...
            <div class="cover_div2" style="padding-top: 180px;">
                ...
                <div class="login-title">
                    <h1 class="header2" style="text-align: center;">Welcome Back</h1>
                    <h1 class="cover_h1" style="text-align: center;">Admin</h1>
                    <p class="about-sm-left" style="text-align: center;">Better food for more people
